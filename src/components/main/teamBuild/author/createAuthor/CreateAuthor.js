...
const CreateAuthor = ({ type }) => {
  ...
  const showPortfolioModal = (type, data) => {
    if (type === 'edit') {
      console.log('수정하기');
      setPortfolioShow(!portfolioShow);
    ...
    <>
      ...
      {portfolioShow && (
        <PortfolioModal
          ...
          data={portfolio}
          pfLinks={portfolioLinks}
          setPfLinks={portfolioLinks}
        />
      )}
      ...
      <div className="edit-author-wrap">
        ...
        <section className="edit-section">
          ...
          <div className="section-contents set-introduce">
            ...
            ></textarea>
            <span className={`txt-length ${txtOver}`}>{`${textLen}/1000`}</span>
            <AuthorButton
              btntype="edit"
              btnTxt="수정완료"
                  ...
                  return (
                    <li className="portfolio" key={i}>
                      ...
                      <div className="portfolio-title-box">
                        <strong className="porfolio-title">{data.title}</strong>
                        <div className="edit-delete-box">
                          <EditDeleteButton
                            form="portfolio"
                            handleEdit={() => showPortfolioModal('edit', data)}
                            handleDelete={() =>
